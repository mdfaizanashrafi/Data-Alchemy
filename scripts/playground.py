...
from utils.numpyUtils import(generate_random_choices,
                              ...
                              simulate_random_walk, estimate_pi, create_zeros_array, create_ones_array,
                              create_random_array, \
                              calculate_sum, calculate_mean, find_max, find_min, get_first_element, get_last_element,
                              slice_array, plot_array, \
                              visualize_random_walk, plot_histogram, save_data_to_file, reshape_array,
                              concatenate_array, split_array, \
                              transpose_array, apply_trigonometric, apply_exponential, apply_custom_operation,
                              matrix_multiply, \
                              solve_linear_equation, compute_eigen, compute_determinant, compute_inverse,
                              calculate_variance, calculate_median, \
                              compute_correlation, compute_covariance, demonstrate_broadcasting, standardize_array,
                              plot_heatmap, plot_3d,
                              simulate_coin_toss, simulate_dice_roll,
generate_random_choices)

from utils.numpyUtils import simulate_random_walk, estimate_pi, create_zeros_array, create_ones_array, create_random_array, \
...
from utils.numpyUtils import simulate_coin_toss, simulate_dice_roll
...
from utils.numpyUtils import normalize_array
