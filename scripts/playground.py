...
from utils.numpy_utils import simulate_random_walk, estimate_pi, create_zeros_array, create_ones_array, create_random_array,
...
from utils.numpy_utils import simulate_coin_toss, simulate_dice_roll
